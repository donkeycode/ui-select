 ...
 * Version: 0.14.1 - 2016-04-15T13:05:27.557Z
 * License: MIT
 */
...
$templateCache.put("bootstrap/footer.tpl.html","<li class=\"ui-select-footer ui-select-choices-group\" id=\"ui-select-choices-footer-{{ $select.generatedId }}\"><div id=\"ui-select-choices-row-footer-{{ $select.generatedId }}-{{$index}}\" class=\"ui-select-choices-footer-row\"><span class=\"ui-select-choices-footer-row-inner\" ng-transclude=\"\"></span></div></li>");
...
$templateCache.put("select2/footer.tpl.html","<li role=\"option\" id=\"ui-select-choices-footer-row-{{ $select.generatedId }}-{{$index}}\" class=\"ui-select-footer ui-select-choices-footer-row\"><div class=\"ui-select-choices-footer-row-inner\" ng-transclude=\"\"></div></li>");
...
$templateCache.put("select2/select.tpl.html","<div class=\"ui-select-container select2 select2-container\" ng-class=\"{\'select2-container-active select2-dropdown-open open\': $select.open, \'select2-container-disabled\': $select.disabled, \'select2-container-active\': $select.focus, \'select2-allowclear\': $select.allowClear && !$select.isEmpty()}\"><div class=\"ui-select-match\"></div><div class=\"ui-select-dropdown select2-drop select2-with-searchbox select2-drop-active\" ng-class=\"{\'select2-display-none\': !$select.open}\"><div class=\"select2-search\" ng-show=\"$select.searchEnabled\"><input type=\"text\" autocomplete=\"false\" autocorrect=\"false\" autocapitalize=\"off\" spellcheck=\"false\" role=\"combobox\" aria-expanded=\"true\" aria-owns=\"ui-select-choices-{{ $select.generatedId }}\" aria-label=\"{{ $select.baseTitle }}\" aria-activedescendant=\"ui-select-choices-row-{{ $select.generatedId }}-{{ $select.activeIndex }}\" class=\"ui-select-search select2-input\" ng-model=\"$select.search\"></div><div class=\"ui-select-choices\"></div><div class=\"ui-select-footer\"></div></div></div>");
$templateCache.put("selectize/choices.tpl.html","<div ng-show=\"$select.open\" class=\"ui-select-choices ui-select-dropdown selectize-dropdown single\"><div class=\"ui-select-choices-content selectize-dropdown-content\"><div class=\"ui-select-choices-group optgroup\" role=\"listbox\"><div ng-show=\"$select.isGrouped\" class=\"ui-select-choices-group-label optgroup-header\" ng-bind=\"$group.name\"></div><div role=\"option\" class=\"ui-select-choices-row\" ng-class=\"{active: $select.isActive(this), disabled: $select.isDisabled(this)}\"><div class=\"option ui-select-choices-row-inner\" data-selectable=\"\"></div></div></div></div></div>");
$templateCache.put("selectize/footer.tpl.html","<div role=\"option\" ng-show=\"$select.open\" class=\"ui-select-footer ui-select-choices-footer-row\" ng-class=\"{active: $select.isActive(this), disabled: $select.isDisabled(this)}\"><div class=\"option ui-select-choices-footer-row-inner\" ng-transclude=\"\"></div></div>");
